//! # smsengine-storage-mysql
//!
//!  Reference MySQL storage adapter.
//!
...
pub const PACKAGE_NAME: &str = "smsengine-storage-mysql";
...
mod tests {
    ...
    fn package_metadata_is_set() {
        assert_eq!(PACKAGE_NAME, "smsengine-storage-mysql");
