//! Integration tests for the **FmFeesTransactionChild aggregate** vertical slice.
//!
//! Pins the typed-id contract for
//! [`FmFeesTransactionChild`](educore_finance::aggregate::FmFeesTransactionChild) end-to-end.
...
use educore_finance::value_objects::FmFeesTransactionChildId;
