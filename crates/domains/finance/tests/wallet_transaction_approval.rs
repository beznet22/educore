//! Integration tests for the **WalletTransactionApproval aggregate** vertical slice.
//!
//! Pins the typed-id contract for
//! [`WalletTransactionApproval`](educore_finance::aggregate::WalletTransactionApproval) end-to-end.
...
use educore_finance::value_objects::WalletTransactionApprovalId;
