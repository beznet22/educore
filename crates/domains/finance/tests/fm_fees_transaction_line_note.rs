//! Integration tests for the **FmFeesTransactionLineNote aggregate** vertical slice.
//!
//! Pins the typed-id contract for
//! [`FmFeesTransactionLineNote`](educore_finance::aggregate::FmFeesTransactionLineNote) end-to-end.
...
use educore_finance::value_objects::FmFeesTransactionLineNoteId;
...
fn fm_fees_transaction_line_note_id(g: &SystemIdGen, school: SchoolId) -> FmFeesTransactionLineNoteId {
