//! Integration tests for the **DirectFeesInstallmentAssignChild aggregate** vertical slice.
//!
//! Pins the typed-id contract for
//! [`DirectFeesInstallmentAssignChild`](educore_finance::aggregate::DirectFeesInstallmentAssignChild) end-to-end.
...
use educore_finance::value_objects::DirectFeesInstallmentAssignChildId;
...
fn direct_fees_installment_assign_child_id(g: &SystemIdGen, school: SchoolId) -> DirectFeesInstallmentAssignChildId {
