//! Integration tests for the **FmFeesInvoiceLineNote aggregate** vertical slice.
//!
//! Pins the typed-id contract for
//! [`FmFeesInvoiceLineNote`](educore_finance::aggregate::FmFeesInvoiceLineNote) end-to-end.
...
use educore_finance::value_objects::FmFeesInvoiceLineNoteId;
