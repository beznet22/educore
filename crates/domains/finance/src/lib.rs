...
pub mod prelude {
    ...
    pub use crate::commands::{
        ...
        CreateIncomeHeadCommand, CreateInvoiceSettingCommand, CreateQuestionBankFeeCommand,
        CreateWalletCommand, CreditWalletCommand,
    ...
    pub use crate::services::{
        ...
        credit_wallet, deduct_wallet_credit, record_expense, record_payment,
