...
pub mod prelude {
    ...
    CreateFeesDiscountCommand,
        ...
        CloseFeesInstallmentAssignCommand, CancelFeesInstallmentAssignCommand,
        ...
        RecordProductPurchaseReceiptCommand, CancelProductPurchaseCommand,
    ...
    pub use crate::events::{
        ...
        TransactionPosted,
        ProductPurchaseReceived, ProductPurchaseCancelled,
    ...
    pub use crate::services::{
        ...
        close_fees_installment_assign, cancel_fees_installment_assign,
        ...
        post_transaction,
        record_product_purchase_receipt, cancel_product_purchase,
    ...
    pub use crate::value_objects::{
        ...
        FmFeesTransactionId, FmFeesTypeId, FmFeesTypeKind, FmFeesWeaverId, FmInvoiceType, GatewayMode, GatewayChargeType,
        LifecycleStatus, PaymentMode, ProductPurchaseLifecycleStatus, TransactionLifecycleStatus,
