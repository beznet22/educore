//! # smsengine-academic
//!
//!  Student lifecycle, classes, sections, subjects, academic year, enrollment, promotion.
//!
...
pub const PACKAGE_NAME: &str = "smsengine-academic";
...
mod tests {
    ...
    fn package_metadata_is_set() {
        assert_eq!(PACKAGE_NAME, "smsengine-academic");
