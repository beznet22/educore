...
pub mod prelude {
    ...
    pub use crate::aggregate::{
        ...
        ChatInvitationType, ChatMessage, ChatStatusRecord, Complaint, ComplaintType,
        ContactMessage, CustomSmsSetting, EmailLog, EmailSetting, Notice, Notification,
        NotificationSetting, PhoneCallLog, SendMessage, SmsGateway, SmsLog, SmsTemplate,
        SpeechSlider,
    };
    ...
    pub use crate::entities::{
        ...
        ComplaintNote, ContactMessageReply, CustomSmsSettingParam, EmailSettingSecret,
        NoticeAttachment, NoticeAudience, NotificationDeliveryAttempt, NotificationSettingAudience,
        SendMessageRecipient, SmsGatewayCredential, SmsTemplateVariable,
    };
    ...
    pub use crate::events::{
        ...
        ChatInvitationSent, ChatMessageDeleted, ChatMessageSeen, ChatMessageSent, ChatStatusSet,
        ComplaintAssigned, ComplaintNoteAdded, ComplaintRegistered, ComplaintResolved,
        ComplaintStatusChanged, ComplaintTypeCreated, ComplaintTypeDeleted, ComplaintTypeUpdated,
        ContactMessageReceived, ContactMessageReplied, ContactMessageViewed,
        CustomSmsSettingCreated, CustomSmsSettingDeleted, CustomSmsSettingUpdated, EmailLogged,
        EmailSettingActivated, EmailSettingConfigured, EmailSettingDeleted, GroupMessageMarkedRead,
        GroupMessageRecipientRecorded, GroupMessageRemovedForUser, NoticeCreated, NoticeDeleted,
        NoticePublished, NoticeUnpublished, NoticeUpdated, NotificationRead, NotificationSent,
        NotificationWithdrawn, PhoneCallFollowUpUpdated, PhoneCallLogged, SendMessageCancelled,
        SendMessageCreated, SendMessageDispatched, SmsLogged, SmsTemplateCreated,
        SmsTemplateDeleted, SmsTemplateDisabled, SmsTemplateEnabled, SmsTemplateUpdated,
        SpeechSliderCreated, SpeechSliderDeleted, SpeechSliderUpdated, UserBlocked, UserUnblocked,
    };
    ...
    pub use crate::query::{
        ...
        CustomSmsSettingQuery, EmailLogQuery, EmailSettingQuery, NoticeQuery, NotificationQuery,
        NotificationSettingQuery, PhoneCallLogQuery, SendMessageQuery, SmsGatewayQuery,
        SmsLogQuery, SmsTemplateQuery, SpeechSliderQuery,
    };

    // 26 repository ports
    pub use crate::repository::{
        AbsentNotificationTimeSetupRepository, ChatBlockUserRepository, ChatConversationRepository,
        ChatGroupMessageRecipientRepository, ChatGroupMessageRemoveRepository, ChatGroupRepository,
        ChatGroupUserRepository, ChatInvitationRepository, ChatInvitationTypeRepository,
        ChatMessageRepository, ChatStatusRepository, ComplaintRepository, ComplaintTypeRepository,
        ContactMessageRepository, CustomSmsSettingRepository, EmailLogRepository,
        EmailSettingRepository, NoticeRepository, NotificationRepository,
        NotificationSettingRepository, PhoneCallLogRepository, SendMessageRepository,
        SmsGatewayRepository, SmsLogRepository, SmsTemplateRepository, SpeechSliderRepository,
    };

    // 7 headline service fns
    pub use crate::services::{
        mark_as_read, notify_user, send_chat_message, send_complaint_message, send_email_message,
        send_notice_message, send_sms_message,
    };
    ...
    pub use crate::services::{
        ...
        configure_sms_gateway, create_chat_group, create_complaint_type, create_custom_sms_setting,
        create_notification_setting, create_send_message, create_sms_template,
        create_speech_slider, delete_chat_group, delete_chat_message, delete_complaint_type,
        delete_custom_sms_setting, delete_email_setting, delete_notification_setting,
        delete_sms_gateway, delete_sms_template, delete_speech_slider, disable_absent_notification,
        disable_sms_template, dispatch_send_message, enable_absent_notification,
        enable_sms_template, log_email_sent, log_phone_call, log_sms_sent, mark_chat_message_seen,
        mark_contact_message_viewed, mark_group_message_read, mark_notification_read,
        open_chat_conversation, publish_notice, receive_contact_message,
        record_group_message_recipient, register_complaint, reject_chat_invitation,
        remove_user_from_chat_group, reply_to_contact_message, send_chat_invitation,
        send_notification, set_chat_group_read_only, set_chat_group_user_role, set_chat_status,
    ...
    pub use crate::commands::{
        ...
        CreateCustomSmsSettingCommand, CreateNoticeCommand, CreateNotificationSettingCommand,
        CreateSendMessageCommand, CreateSmsTemplateCommand, CreateSpeechSliderCommand,
        DeleteChatGroupCommand, DeleteChatMessageCommand, DeleteComplaintTypeCommand,
        DeleteCustomSmsSettingCommand, DeleteEmailSettingCommand, DeleteNotificationSettingCommand,
        DeleteSmsGatewayCommand, DeleteSmsTemplateCommand, DeleteSpeechSliderCommand,
        DisableAbsentNotificationCommand, DisableSmsTemplateCommand, DispatchSendMessageCommand,
        EnableAbsentNotificationCommand, EnableSmsTemplateCommand, LogEmailSentCommand,
        LogPhoneCallCommand, LogSmsSentCommand, MarkChatMessageSeenCommand,
        MarkContactMessageViewedCommand, MarkGroupMessageReadCommand, MarkNotificationReadCommand,
        OpenChatConversationCommand, PublishNoticeCommand, ReceiveContactMessageCommand,
        RecordGroupMessageRecipientCommand, RegisterComplaintCommand, RejectChatInvitationCommand,
        RemoveUserFromChatGroupCommand, ReplyToContactMessageCommand, ResolveComplaintCommand,
        SendChatInvitationCommand, SendChatMessageCommand, SendNotificationCommand,
        SetChatGroupReadOnlyCommand, SetChatGroupUserRoleCommand, SetChatStatusCommand,
        UnblockUserCommand, UnpublishNoticeCommand, UpdateChatGroupCommand,
        UpdateComplaintStatusCommand, UpdateComplaintTypeCommand, UpdateCustomSmsSettingCommand,
        UpdateNoticeCommand, UpdateNotificationSettingCommand, UpdatePhoneCallFollowUpCommand,
        UpdateSpeechSliderCommand, WithdrawNotificationCommand,
    };
    ...
    pub use crate::value_objects::{
        ...
        AbsentNotificationDispatchId,
        // 27 enums
        AbsentNotificationStatus,
        AbsentNotificationTimeSetupId,
        ...
        ChatBlockUserId,
        ChatConversationId,
        ChatConversationLastReadId,
        ChatGroupAvatarId,
        ChatGroupId,
        ChatGroupMessageId,
        ChatGroupMessageRecipientId,
        ...
        ChatInvitationTypeEnum,
        ChatInvitationTypeId,
        ChatMessageId,
        ChatMessageStatus,
        ChatStatus,
        ChatStatusId,
        ...
        ComplaintTypeId,
        ContactMessageId,
        ContactMessageReplyId,
        ContactMessageReplyStatus,
        ContactMessageViewStatus,
        CustomSmsSettingId,
        Destination,
        DispatchDate,
        EmailAddress,
        ...
        SecretReference,
        SendMessageId,
        SendMessageRecipientId,
        SendMessageStatus,
        Slug,
        SmsGatewayCredentialId,
