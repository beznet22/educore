//! # smsengine-communication
//!
//!  Notices, complaints, chat, email/SMS logs, notifications, contact messages.
//!
...
pub const PACKAGE_NAME: &str = "smsengine-communication";
...
mod tests {
    ...
    fn package_metadata_is_set() {
        assert_eq!(PACKAGE_NAME, "smsengine-communication");
