//! # smsengine-platform
//!
//!  Multi-tenancy substrate: schools, users, OTP, courses, modules, plugins.
//!
...
pub const PACKAGE_NAME: &str = "smsengine-platform";
...
mod tests {
    ...
    fn package_metadata_is_set() {
        assert_eq!(PACKAGE_NAME, "smsengine-platform");
