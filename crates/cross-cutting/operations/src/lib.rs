...
//!
//!  Operations domain — backups, jobs, system versions, user logs, runtime maintenance.
//!
...
pub const PACKAGE_NAME: &str = "smsengine-operations";
...
mod tests {
    ...
    fn package_metadata_is_set() {
        assert_eq!(PACKAGE_NAME, "smsengine-operations");
