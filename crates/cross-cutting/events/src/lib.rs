//! # smsengine-events
//!
//!  Domain event envelope, event bus port, in-process and outbox implementations.
//!
...
pub const PACKAGE_NAME: &str = "smsengine-events";
...
mod tests {
    ...
    fn package_metadata_is_set() {
        assert_eq!(PACKAGE_NAME, "smsengine-events");
