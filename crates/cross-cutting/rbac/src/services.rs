...
impl DefaultRoleCatalog {
    ...
    pub fn school_admin() -> BTreeSet<Capability> {
        ...
        s.extend([
            ...
            Capability::CmsNewsIncrementView,
            Capability::CmsNewsCategoryCreate,
            Capability::CmsNewsCategoryRead,
            Capability::CmsNewsCategoryUpdate,
            Capability::CmsNewsCategoryDelete,
            Capability::CmsNewsCommentCreate,
            Capability::CmsNewsCommentModerate,
            Capability::CmsNewsCommentDelete,
            Capability::CmsNewsCommentRead,
            Capability::CmsNewsPageCreate,
            Capability::CmsNewsPageRead,
            Capability::CmsNewsPageUpdate,
            Capability::CmsNewsPageDelete,
            Capability::CmsNoticeBoardCreate,
            Capability::CmsNoticeBoardRead,
            Capability::CmsNoticeBoardUpdate,
            Capability::CmsNoticeBoardDelete,
            Capability::CmsNoticeBoardPublish,
            Capability::CmsNoticeBoardUnpublish,
            Capability::CmsTestimonialCreate,
            Capability::CmsTestimonialRead,
            Capability::CmsTestimonialUpdate,
            Capability::CmsTestimonialDelete,
            Capability::CmsHomeSliderCreate,
            Capability::CmsHomeSliderRead,
            Capability::CmsHomeSliderUpdate,
            Capability::CmsHomeSliderDelete,
            Capability::CmsSpeechSliderCreate,
            Capability::CmsSpeechSliderRead,
            Capability::CmsSpeechSliderUpdate,
            Capability::CmsSpeechSliderDelete,
            Capability::CmsContentCreate,
            Capability::CmsContentRead,
            Capability::CmsContentUpdate,
            Capability::CmsContentDelete,
            Capability::CmsContentTypeCreate,
            Capability::CmsContentTypeRead,
            Capability::CmsContentTypeUpdate,
            Capability::CmsContentTypeDelete,
            Capability::CmsContentShareListCreate,
            Capability::CmsContentShareListRead,
            Capability::CmsContentShareListUpdate,
            Capability::CmsContentShareListDelete,
            Capability::CmsContentShareListDispatch,
            Capability::CmsContentShareListCancel,
            Capability::CmsTeacherUploadContentCreate,
            Capability::CmsTeacherUploadContentRead,
            Capability::CmsTeacherUploadContentUpdate,
            Capability::CmsTeacherUploadContentDelete,
            Capability::CmsUploadContentCreate,
            Capability::CmsUploadContentRead,
            Capability::CmsUploadContentUpdate,
            Capability::CmsUploadContentDelete,
            Capability::CmsAboutPageCreate,
            Capability::CmsAboutPageRead,
            Capability::CmsAboutPageUpdate,
            Capability::CmsAboutPageDelete,
            Capability::CmsContactPageCreate,
            Capability::CmsContactPageRead,
            Capability::CmsContactPageUpdate,
            Capability::CmsContactPageDelete,
            Capability::CmsCoursePageCreate,
            Capability::CmsCoursePageRead,
            Capability::CmsCoursePageUpdate,
            Capability::CmsCoursePageDelete,
            Capability::CmsHomePageSettingConfigure,
            Capability::CmsHomePageSettingRead,
            Capability::CmsHomePageSettingDelete,
            Capability::CmsFrontendPageCreate,
            Capability::CmsFrontendPageRead,
            Capability::CmsFrontendPageUpdate,
            Capability::CmsFrontendPageDelete,
            Capability::CmsRead,
    ...
    /// Marketing: public-site surface (per `docs/specs/cms/permissions.md`
    /// § Default Role Mapping). Pages, news, testimonials, sliders,
    /// home-page setting, course pages, content uploads, notice
    /// boards. The marketing role does NOT hold any finance /
    /// HR / academic capabilities.
    #[must_use]
    pub fn marketing() -> BTreeSet<Capability> {
        let mut s: BTreeSet<Capability> = BTreeSet::new();
        s.extend([
            Capability::PlatformUserRead,
            Capability::RbacCapabilityRead,
