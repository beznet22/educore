//! # smsengine-auth
//!
//!  Authentication port, local-password, OAuth2, SAML, JWT adapter implementations.
//!
...
pub const PACKAGE_NAME: &str = "smsengine-auth";
...
mod tests {
    ...
    fn package_metadata_is_set() {
        assert_eq!(PACKAGE_NAME, "smsengine-auth");
