...
| 13    | Events domain (calendar)           | `events-domain`                                                        | Done     | Yes (7 root aggregates + 4 child entities; Wave 23 added AssignIncident + IncidentComment; Wave 5 added integration tests for CalendarSetting/Weekend/Holiday; 34 unit tests in crate + 7-scenario storage-parity integration test; 9 coverage rows flipped; see `docs/handoff/PHASE-13-HANDOFF.md`) |
| 14    | Settings + Operations              | `settings`, `operations`                                               | Done     | Yes (15 settings + 8 operations root aggregates; 53 + 25 typed events; 100 net-new Capability variants (66 Settings + 34 Operations); 23 net-new AuditTarget variants; 43 + 47 unit tests in crates; 28 coverage rows flipped; see `docs/handoff/PHASE-14-HANDOFF.md`) |
