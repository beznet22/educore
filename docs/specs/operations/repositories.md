...
CREATE INDEX ix_version_histories_version ON version_histories (version);
...
CREATE UNIQUE INDEX ux_maintenance_settings_school_id ON maintenance_settings (school_id);
